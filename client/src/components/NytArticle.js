  ...
  render() {
    return (
      <li className="nytArticle">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        <span className='edit-item'><a href='#' data-nytarticleid={this.props.nytArticleId} onClick={this._handleEdit}>Add</a></span>
        &nbsp;&nbsp;&nbsp;&nbsp;
      </li>
    );
  }
...
NytArticle.propTypes = {
  nytArticleId: React.PropTypes.string.isRequired,
